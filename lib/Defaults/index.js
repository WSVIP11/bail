...
const WA_VERSION = "2.26.13.23";
const WA_VERSION_HASH = (0, crypto_1.createHash)("md5")
  .update(WA_VERSION)
  .digest("hex");
exports.MOBILE_TOKEN = Buffer.from(
  "USUDuDYDeQhY4RF2fCSp5m3F6kJ1M2J8wS7bbNA2" + WA_VERSION_HASH,
);
exports.MOBILE_REGISTRATION_ENDPOINT = "https://v.whatsapp.net/v2";
//exports.MOBILE_USERAGENT = `WhatsApp/${WA_VERSION} iOS/18.1.1 Device/Apple-iPhone_15_Pro_Max`;
exports.MOBILE_USERAGENT = `WhatsApp/${WA_VERSION} Android/11.0.0 Device/xiaomi-Mi11 Pro 5G`;
